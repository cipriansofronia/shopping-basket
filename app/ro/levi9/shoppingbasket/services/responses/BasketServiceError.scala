...
object BasketServiceError {
  ...
  case object InsufficientStockError extends BasketServiceError { override val message: String = "Requested item is out of stock or maybe you've requested more than the stock has!" }
